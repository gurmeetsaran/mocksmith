...
def demonstrate_pydantic_features():
    ...
    # 3c. Custom validator
    try:
        Employee(employee_id=5, email="test@gmail.com", username="test")  # Wrong domain
    except ValidationError as e:
    ...
    for value in ["yes", "no", "1", "0", "true", "false", "Y", "N"]:
        emp = Employee(employee_id=99, email="bool@company.com", username="bool", is_active=value)
    ...
    print(
        f"   Stored in model: '{employee5.employee_code}' (length {len(employee5.employee_code)})"
    )
